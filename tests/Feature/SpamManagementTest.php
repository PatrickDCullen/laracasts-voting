...
class SpamManagementTest extends TestCase
{
    ...
    /** @test */
    public function marking_an_idea_as_not_spam_shows_on_menu_when_user_has_authorization_and_idea_has_spam_reports()
    {
        $user = User::factory()->admin()->create();
        $idea = Idea::factory()->create([
            'spam_reports' => 1,
    ...
    /** @test */
    public function marking_an_idea_with_spam_reports_as_not_spam_does_not_show_on_menu_when_user_does_not_have_authorization()
    {
        $idea = Idea::factory()->create([
            'spam_reports' => 1,
        ]);
