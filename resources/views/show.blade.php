        ...
        <div class="flex flex-1 px-4 py-6">
            ...
            <div class="w-full mx-4">
                ...
                <div class="text-gray-600 mt-3">
                    Lorem ipsum dolor sit amet consectetur. Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque sequi maxime quisquam vero, voluptatum inventore incidunt placeat repellat libero tenetur minima consequatur cumque sed, dicta fugit maiores expedita nisi labore.
                </div>
        ...
        <div class="flex items-center space-x-4 ml-6">
                    ...
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div>
                            <textarea name="post_comment" id="post_comment" cols="30" rows="4"
                                ...
                                placeholder="Go head, don't by shy. Share your thoughts..."></textarea>
                        </div>
            ...
            <div class="relative">
                ...
                <div class="absolute z-20 w-76 text-left font-semibold text-sm bg-white shadow-dialog rounded-xl mt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <label class="inline-flex item-center">
