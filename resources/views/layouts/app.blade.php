                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div x-data="{ isOpen: false }" class="relative">
                                    <button @click="isOpen = !isOpen">
                                        ...
                                        <div class="absolute rounded-full bg-red text-white text-xxs w-6 h-6 flex justify-center items-center -top-1 -right-1 border-2">5</div>
                                    </button>
                                            ...
                                            >
                                                ...
                                                <div class="ml-4">
                                                    <div class="line-clamp-6">
                                                        ...
                                                        <span>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Facere modi ipsum, magnam vel earum natus pariatur mollitia animi nam distinctio facilis. Debitis itaque reprehenderit voluptatum ipsam repellat amet quisquam quibusdam, quo quia, adipisci molestias beatae dolore ab iusto incidunt fugiat sed, corporis quas odio id quae! Ullam minima reprehenderit exercitationem placeat quis dolorem, neque, maxime libero non ut enim autem incidunt cumque iusto eius blanditiis delectus error quo esse maiores dolor at atque nemo necessitatibus. Vitae asperiores culpa quis maiores laudantium placeat magnam quia commodi fugiat accusamus alias officia quam dicta odit, neque sint, labore ratione eos ipsa ea! Ipsam!</span>
                                                    </div>
                                            ...
                                            >
                                                ...
                                                <div class="ml-4">
                                                    <div>
                                                        <span class="font-semibold">drehimself</span> commented on
                                                        <span class="font-semibold">This is my idea</span>:
                                                        <span>"Lorem, ipsum dolor sit amet consectetur adipisicing elit. Facere repellat numquam debitis beatae, autem ut provident cupiditate sed aperiam obcaecati."</span>
                                                    </div>
                                                    <div class="text-xs text-gray-500 mt-2">1 hour ago</div>
                                                </div>
                                            </a>
