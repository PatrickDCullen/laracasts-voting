...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <main class="container mx-auto max-w-custom flex" style="max-width:1000px">
            <div class="w-70 mr-5">
                Add idea form goes here. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sit iste debitis accusantium reiciendis, doloribus, deleniti optio voluptatum incidunt deserunt velit assumenda vero laudantium obcaecati unde cumque. Asperiores, autem iusto. Officiis distinctio nisi aperiam quidem in impedit, quo facere vel repellendus?
            </div>
            <div class="w-175">
